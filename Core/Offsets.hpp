...
constexpr long OFF_REGION = 0x140000000; //[Static]->Region
        ...
        constexpr long OFF_NAME_LIST = 0xd350450;//[Miscellaneous]->NameList
        ...
        constexpr long OFF_CAMERAORIGIN = 0x1ee0;   //[Miscellaneous]->CPlayer!camera_origin 0x1ee0
        ...
        constexpr long OFF_PROJECTILESCALE = 0x04f4 + 0x19d8; // [WeaponSettings]->projectile_gravity_scale + [WeaponSettingsMeta]->base
        constexpr long OFF_PROJECTILESPEED = 0x04ec + 0x19d8; // [WeaponSettings]->projectile_launch_speed + [WeaponSettingsMeta]->base
        ...
        constexpr long OFF_GLOW_HIGHLIGHTS = 0xB17E1A0; //0xb13b520
